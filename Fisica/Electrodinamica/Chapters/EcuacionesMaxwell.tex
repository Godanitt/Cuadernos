...
\section{Potenciales electromagnéticos}
...
\section{Ecuaciones de Maxwell en medios materiales}
...
(ii) & \hnn \cdot (\Bn_2 - \Bn_1) = 0   \\ \\
(iii) & \hnn \times ( \En_2 - \En_1) = 0 \\ \\
(iv) & \hnn \times \parentesis{\dfrac{\Bn_2}{\mu_2} - \dfrac{\Bn_1}{\mu_1}} = -  \Kn_f
\end{array} \label{Ec:01.4.18}
\end{equation}
