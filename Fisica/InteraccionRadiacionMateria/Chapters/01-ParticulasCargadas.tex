...
\end{equation}
En el Ejercicio \ref{Ej:01.01} dejamos para hacer la derivación de esta fórmula.  Como podemos comprobar, \textit{diverge} para $\theta=0$, lo cual es debido al carácter ideal del núcleo puntual. La razón por la que en realidad no diverge, o la solución a esta divergencia, es que la carga nuclear está apantallada por los \textit{electrones orbitales atómicos}, lo que conduce a un ángulo mínimo $\theta_{\min}$. La dispersión hacia atrás ($\theta \to \pi, b \to 0$) tampoco se logra nunca, debido al radio finito del núcleo. 
...
\begin{Ejemplo}
    Hola buenas tardes, como están los máquinas
\end{Ejemplo}
\begin{Teorema}
    Hola buenas tardes, como están los máquinas
\end{Teorema}
...
\begin{Ejercicio} \label{Ej:01.01}
...
\begin{Ejercicio} \label{Ej:01.02}
