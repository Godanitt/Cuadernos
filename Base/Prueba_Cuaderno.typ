...
#show: book.with(
  ...
  date: datetime.today,
  author: ("Daniel Vázquez Lago","Jose Carlos Vázquez Míguez"),
  main-color: rgb("#700e60"),
  lang: "es",
  cover: none,
  image-index: none,
...
#lorem(50) #footnote[Footnote example text...Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent porttitor arcu luctus,
