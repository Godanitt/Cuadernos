...
#let notebook-config = (
  ...
  lang: "es",
  cover: "/cuadernos/Fisica/Electrodinamica/generated/cover-extracted.png",
  format: "fullimage",
  cover-theme: "dark",
  cover-zoom: 1,
  cover-dx: 0cm,
...
#let bibliography-file = "/cuadernos/Fisica/Electrodinamica/Bibliografia/referencias.bib"
