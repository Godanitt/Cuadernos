...
#let notebook-config = (
  ...
  lang: "es",
  cover: "/cuadernos/Fisica/Semiconductores/generated/cover-extracted.png",
  format: "fullimage",
  cover-theme: "dark",
  cover-zoom: 1.1,
  cover-dx: 0cm,
...
#let bibliography-file = "/cuadernos/Fisica/Semiconductores/Bibliografia/referencias.bib"
