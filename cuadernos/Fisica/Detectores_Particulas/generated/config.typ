...
#let notebook-config = (
  ...
  lang: "es",
  cover: "/cuadernos/Fisica/Detectores_Particulas/generated/cover-extracted.png",
  format: "fullimage",
  cover-theme: "dark",
  cover-zoom: 1,
  cover-dx: 0cm,
...
#let bibliography-file = "/cuadernos/Fisica/Detectores_Particulas/Bibliografia/referencias.bib"
