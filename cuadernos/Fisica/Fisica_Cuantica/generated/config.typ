...
#let notebook-config = (
  ...
  lang: "es",
  cover: "/cuadernos/Fisica/Fisica_Cuantica/generated/cover-extracted.png",
  format: "fullimage",
  cover-theme: "dark",
  cover-zoom: 1.1,
  cover-dx: 0cm,
...
#let bibliography-file = "/cuadernos/Fisica/Fisica_Cuantica/Bibliografia/referencias.bib"
