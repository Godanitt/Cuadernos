...
#let notebook-config = (
  ...
  lang: "es",
  cover: "/cuadernos/Fisica/Fisica_Particulas/generated/cover-extracted.png",
  format: "fullimage",
  cover-theme: "dark",
  cover-zoom: 1.1,
  cover-dx: 0cm,
...
#let bibliography-file = "/cuadernos/Fisica/Fisica_Particulas/Bibliografia/referencias.bib"
