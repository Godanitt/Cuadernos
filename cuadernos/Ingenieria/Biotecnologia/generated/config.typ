...
#let notebook-config = (
  ...
  lang: "es",
  cover: "/cuadernos/Ingenieria/Biotecnologia/generated/cover-extracted.png",
  format: "fullimage",
  cover-theme: "dark",
  cover-zoom: 1,
  cover-dx: 0cm,
...
#let bibliography-file = "/cuadernos/Ingenieria/Biotecnologia/Bibliografia/referencias.bib"
