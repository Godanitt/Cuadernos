...
#let notebook-config = (
  ...
  third-color: rgb("#376335"),
  lang: "es",
  cover: "/cuadernos/Ingenieria/Sensores_Instrumentacion/generated/cover-extracted.png",
  format: "fullimage",
  cover-theme: "dark",
  cover-zoom: 1,
  cover-dx: 0cm,
...
#let bibliography-file = "/cuadernos/Ingenieria/Sensores_Instrumentacion/Bibliografia/referencias.bib"
