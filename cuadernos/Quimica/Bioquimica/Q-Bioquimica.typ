...
#let notebook = (
  ...
  output: "Q-Bioquimica.pdf",
  bibliography: "referencias.bib",
  bibliography_enabled: false,
  summary: "Cuaderno planificado con 6 partes previstas.",
  scope: "Incluirá Estructura de biomoléculas, Enzimología, Bioenergética y metabolismo, Información genética y síntesis proteica, Señalización y regulación metabólica y Métodos bioquímicos y aplicaciones biomédicas.",
  out_of_scope: "",
  tags: ("bioquimica",),
  cover: (
      style: "solid",
...
#part("Estructura de biomoléculas")
