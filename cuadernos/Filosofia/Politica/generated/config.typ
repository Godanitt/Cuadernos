...
#let notebook-config = (
  ...
  main-color: rgb("#0f1434"),
  seccond-color: rgb("#292c3e"),
  third-color: rgb("#0f1434"),
  lang: "es",
  cover: "/cuadernos/Filosofia/Politica/generated/cover-extracted.png",
  format: "fullimage",
  cover-theme: "dark",
  cover-zoom: 1,
  cover-dx: 0cm,
...
#let bibliography-file = "/cuadernos/Filosofia/Politica/Bibliografia/referencias.bib"
